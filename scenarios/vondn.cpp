 ...
 *
 * Authors: Ertugrul Dogruluk. <d7474@di.uminho.pt>, Centro Algorithmi, University of Minho. Portugal.
 */
...
int normalNetworkConfiguration(string prefix, NodeContainer nodes) {
	...
	if (prefix == "default") {
		...
		helper.Install(nodes);
		StrategyChoiceHelper::Install(nodes, "/vondn",
				"/localhost/nfd/strategy/best-route"); // nfd:DaD best-route forwarding strategy
	} else if (prefix == "dad2") {
